...
class ChargingReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        fun handle(context: Context?, intent: Intent?) {
            if (intent?.action == "moe.hx030.chargecontrol.UNLIMIT_CHARGING" || intent?.action == null) {
                ...
                Utils.cancelAlarm(context!!, this::class.java)
        ...
        fun maybeScheduleAlarm(context: Context?) {
